...
const en = {
  ...
  'settings.readingScale': 'Text size',
  'settings.readingScaleHint': 'Scale the text inside posts and messages.',
...
const bg: Record<MsgKey, string> = {
  ...
  'settings.readingScale': 'Размер на текста',
  'settings.readingScaleHint': 'Мащабира текста в публикациите и съобщенията.',
